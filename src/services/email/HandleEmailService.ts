...
class HandleEmailService {
  ...
  async runPassInitial(email: String, name: String, passProvisional: String) {
  ...
  async runPassProvisional(
    user: any,
    passProvisional: String
  ) {
  ...
  async runInfoUpdatePassword(user: any) {
  ...
  async runInfoDeleteAccount(user: any) {
    const date = new Date();
...
export default new HandleEmailService();
